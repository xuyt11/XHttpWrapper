...
public class Config {
    ...
    public static final String BaseOutputPath = BasePath + "newApi/";
    ...
    public static final class Api {
        /** 接口文件保存目录 */
        private static final String DirPath = BaseOutputPath + "%s/api/";
        /** 接口文件的包名*/
    ...
    public static final class Entity {
        /** 实体类文件保存目录 */
        private static final String DirPath = BaseOutputPath + "%s/entity/";
        /** 实体类文件保存目录---v5 */
        private static final String DirPath4Category = BaseOutputPath + "%s/entity/%s/";
        /** 实体类文件的包名*/
        ...
        public static final class BaseResponse {
            ...
            /** 实体类文件保存目录 */
            public static final String DirPath = BaseOutputPath + "";
            /** 实体类文件的包名*/
