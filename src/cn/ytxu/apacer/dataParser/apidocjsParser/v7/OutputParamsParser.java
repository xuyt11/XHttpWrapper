...
public class OutputParamsParser {
    ...
    private static void parserOneResponse(int categoryIndex, int methodIndex, ResponseEntity response) {
        ...
        if (jObj.containsKey(ConfigV6.Entity.BaseResponse.StatusCode)) {// TODO 未来要他们统一返回格式,有些result没有这个字段
            response.setStatusCode(String.valueOf(jObj.getInteger(ConfigV6.Entity.BaseResponse.StatusCode)));
        } else {
