package cn.ytxu.apacer.fileCreater.newchama.resultEntity.v5;
...
public class OutputClassCreater {
    ...
    public void create(OutputParamEntity output, String packageName, String dirPath) {
        int tabIndex = 0;
        String className;
        ...
        String classFileFullName = className + ".java";
        Writer writer = null;
        try {
            writer = FileUtil.getWriter(classFileFullName, dirPath);

            createPackageAndImports(writer, packageName, className, tabIndex);
    ...
    // package and imports
    private void createPackageAndImports(Writer writer, String packageName, String className, int tabIndex) throws IOException {
