...
public class ResultEntityCreater {
    ...
    public void create(CategoryEntity category, ApiEnitity api, DocumentEntity doc) {
        ...
        try {
            ...
            createResultFieldsForEachMethods(writer, methods, classFileName, doc);
    ...
    private void createResultFieldsForEachMethods(Writer writer, List<MethodEntity> methods, String classFileName, DocumentEntity doc) throws IOException {
