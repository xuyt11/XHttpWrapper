 ...
 */
public class RequestHeaderExampleModel extends FieldExampleModel<RequestHeaderModel> {

    public RequestHeaderExampleModel(RequestHeaderModel higherLevel, ExampleBean element) {
