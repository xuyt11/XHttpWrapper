 ...
 */
public class RequestInputExampleModel extends FieldExampleModel<RequestInputContainerModel> {

    public RequestInputExampleModel(RequestInputContainerModel higherLevel, ExampleBean element) {
